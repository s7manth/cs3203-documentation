...
const PKB_SUBROWS: SubRow[] = [
  ...
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddCallStatementToProcedureName(const StatementNumber &statement_number, const Procedure &procedure)",
    "description": "",
    "returnType": "void"
  },
  {
  ...
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddCallsRelation(const Procedure &caller_procedure, const Procedure &callee_procedure)",
    "description": "",
    "returnType": "void"
  },
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddWhileStatementAndCondition(const StatementNumber &statement_number, const ExpressionPtr &expression)",
    "description": "",
    "returnType": "void"
  },
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddIfStatementAndCondition(const StatementNumber &statement_number, const ExpressionPtr &expression)",
    "description": "",
    "returnType": "void"
  },
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddAssignmentStatementAndExpression(const StatementNumber &statement_number, const ExpressionPtr &expression)",
    "description": "",
    "returnType": "void"
  },
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddExpressionSideEffects(const StatementNumber &statement_number, const ExpressionPtr &expression)",
    "description": "",
    "returnType": "void"
  },
  {
  ...
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddParentRelation(const StatementNumber &statement_number_1, const StatementNumber &statement_number_2)",
    "description": "",
    "returnType": "void"
  },
  {
  ...
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddFollowsRelation(const StatementNumber &statement_number_1, const StatementNumber &statement_number_2)",
    "description": "",
    "returnType": "void"
  },
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddProcedureModifyingVariable(const Procedure &procedure, const Variable &variable)",
    "description": "",
    "returnType": "void"
  },
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddStatementModifyingVariable(const StatementNumber &statement_number, const Variable &variable)",
    "description": "",
    "returnType": "void"
  },
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddProcedureUsingVariable(const Procedure &procedure, const Variable &variable)",
    "description": "",
    "returnType": "void"
  },
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddStatementOfAType(const StatementNumber &statement_number, const StatementType &statement_type)",
    "description": "",
    "returnType": "void"
  },
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddStatementUsingVariable(const StatementNumber &statement_number, const Variable &variable)",
    "description": "",
    "returnType": "void"
  },
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddModifiesSideEffects(const StatementNumber &statement_number, const Variable &variable)",
    "description": "",
    "returnType": "void"
  },
  {
    "subComponent": "PkbWriteFacade",
    "method": "AddUsesSideEffects(const StatementNumber &statement_number, const Variable &variable)",
    "description": "",
    "returnType": "void"
  },
  {
  ...
  {
    "subComponent": "PkbReadFacade",
    "method": "GetVariablesModifiedByStatement(const StatementNumber &statement_number)",
    "description": "",
    "returnType": "SingleSet"
  },
  {
    "subComponent": "PkbReadFacade",
    "method": "GetModifiesStatementVariablePairs(const StatementType &statement_type)",
    "description": "",
    "returnType": "PairSet"
  },
  {
    "subComponent": "PkbReadFacade",
    "method": "GetStatementsModifiesVariable(const Variable &variable, const StatementType &statement_type)",
    "description": "",
    "returnType": "SingleSet"
  },
  {
    "subComponent": "PkbReadFacade",
    "method": "SingleSet GetStatementsThatModify(const StatementType &statement_type)",
    "description": "",
    "returnType": "SingleSet"
  },
  {
    "subComponent": "PkbReadFacade",
    "method": "HasModifiesStatementRelationship(const StatementNumber &statement_number, const Variable &variable)",
    "description": "",
    "returnType": "bool"
  },
  {
  ...
  {
    "subComponent": "PkbReadFacade",
    "method": "HasModifiesProcedureRelationship(const Procedure &procedure, const Variable &variable)",
    "description": "",
    "returnType": "bool"
  },
  {
    "subComponent": "PkbReadFacade",
    "method": "GetUsesStatementVariablePairs(const StatementType &statement_type)",
    "description": "",
    "returnType": "PairSet"
  },
  {
  ...
  {
    "subComponent": "PkbReadFacade",
    "method": "GetVariablesUsedByStatement(const StatementNumber &statement_number)",
    "description": "",
    "returnType": "SingleSet"
  },
  {
    "subComponent": "PkbReadFacade",
    "method": "GetStatementsUsesVariable(const StatementType &statement_type, const Variable &variable)",
    "description": "",
    "returnType": "SingleSet"
  },
  {
    "subComponent": "PkbReadFacade",
    "method": "HasUsesStatementRelationship(const StatementNumber &statement_number, const Variable &variable)",
    "description": "",
    "returnType": "bool"
  },
  {
  ...
  {
    "subComponent": "PkbReadFacade",
    "method": "HasUsesProcedureRelationship(const Procedure &procedure, const Variable &variable)",
    "description": "",
    "returnType": "bool"
  },
  {
    "subComponent": "PkbReadFacade",
    "method": "GetFollowPairs(const StatementType &statement_type, const StatementType &statement_type_follower)",
    "description": "",
    "returnType": "PairSet"
  },
  {
    "subComponent": "PkbReadFacade",
    "method": "GetStatementFollowedBy(const StatementNumber &statement_number, const StatementType &statement_type)",
    "description": "",
    "returnType": "SingleSet"
  },
  {
    "subComponent": "PkbReadFacade",
    "method": "GetStatementFollowing(const StatementNumber &statement_number, const StatementType &statement_type)",
    "description": "",
    "returnType": "SingleSet"
  },
  {
  ...
  {
    "subComponent": "PkbReadFacade",
    "method": "HasFollowsRelationship(const StatementNumber &statement_number, const StatementNumber &statement_number_follower)",
    "description": "",
    "returnType": "bool"
  },
  {
  ...
  {
    "subComponent": "PkbReadFacade",
    "method": "GetFollowsStarPairs(const StatementType &type_1, const StatementType &type_2)",
    "description": "",
    "returnType": "PairSet"
  },
  {
    "subComponent": "PkbReadFacade",
    "method": "GetFollowsStar(const StatementNumber &statement_number, const StatementType &statement_type)",
    "description": "",
    "returnType": "SingleSet"
  },
  {
    "subComponent": "PkbReadFacade",
    "method": "GetFollowsStarBy(const StatementNumber &statement_number, const StatementType &statement_type);",
    "description": "",
    "returnType": "SingleSet"
  },
  {
  ...
  {
    "subComponent": "PkbReadFacade",
    "method": "IsNextStar(const StatementNumber &statement_num_1, const StatementNumber &statement_num_2)",
    "description": "",
    "returnType": "bool"
  },
  {
...
const QPS_SUBROWS: SubRow[] = [
  ...
  {
    "subComponent": "QpsTokenizer",
    "method": "ExtractAbstractSyntaxFromDeclarations(vector<string> declarations)",
    "description": "",
